...
export const copyUA: Copy = {
  ...
  about: {
    eyebrow: "ПРО ЛІКАРЯ",
    name: "Кирило Щербаков",
    role: "Лікар-стоматолог · Імплантолог · Ортопед",
    paragraphs: [
      "Працюю зі складними випадками: тотальні реабілітації, імплантація, протезування, видалення. Кожна історія пацієнта починається з діагностики та плану.",
      "Моя задача — зробити естетично та стабільно на роки. Не до наступного огляду й не на сезон, а так, щоб результат тримався десятиліттями.",
      "Поза кабінетом — регулярний спорт. Допомагає тримати фокус і вчасно переключатися.",
    ],
  },
  approach: {
    eyebrow: "ПІДХІД",
  ...
  stats: [
    { num: "90+", label: "Завершених повних реабілітацій" },
    { num: "800+", label: "Встановлених імплантів" },
    { num: "2400+", label: "Цифрово спланованих кейсів" },
    { num: "76%", label: "Пацієнтів — за рекомендацією" },
  ],
  cases: {
    ...
    disclaimer:
      "Кейси опубліковані без облич. Пацієнти надали згоду на публікацію. За потреби матеріали можуть бути замінені.",
    blockLabels: {
      patient: "Пацієнт",
      decision: "Рішення",
      outcome: "Результат",
